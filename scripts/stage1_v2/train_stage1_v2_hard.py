...
CONFIG = {
    ...
    "index_file": PROJECT_ROOT / "configs/hard_index.json",
    "batch_size": 16,
    ...
    "print_freq": 10,
    "model_path": PROJECT_ROOT / "models" / "stage1_onePred_epoch30_best.pth"
}
...
def train_stage1():
    ...
    for epoch in range(CONFIG["epochs"]):
        ...
        if val_loss < best_val_loss:
            ...
            save_and_log_checkpoint(model, Path(CONFIG["save_dir"]) / "stage1_hard_best.pth", writer, global_step, upload_to_hf=True)
            print("✅ Saved new best model.")

        scheduler.step()

    # Save last epoch
    save_and_log_checkpoint(model, Path(CONFIG["save_dir"]) / "stage1_hard_last.pth", writer, global_step, upload_to_hf=True)
    writer.close()
