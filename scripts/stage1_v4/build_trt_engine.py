...
def build_engine(onnx_path: str, engine_path: str, fp16: bool = True):
    with trt.Builder(TRT_LOGGER) as builder, \
        ...
        profile.set_shape("current", (1, 3, 300, 300), (1, 3, 300, 300), (3, 3, 300, 300))
        profile.set_shape("past",   (1, 3, 3, 300, 300), (1, 3, 3, 300, 300), (3, 3, 3, 300, 300))
...
if __name__ == "__main__":
    ...
    onnx_path = str(PROJECT_ROOT / "onnx_exports/stage1_v4.onnx")
    engine_path = str(PROJECT_ROOT / "trt_engines/stage1_v4_fp16.engine")
